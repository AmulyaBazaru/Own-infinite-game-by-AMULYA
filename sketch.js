...
function draw() 
{
  ...
  if(gameState===START)
  {
   ...
   text("1.Press Space Key to jump",50,140);
    ...
    text("3.touching the wood can be an END to the game",50,200);
    text("4.Jump on the wood to rest for sometime",50,233);
    text("5.Save the boy from ghost",50,260);
    text("6.Don't let the boy fall down",50,305);
    text("7.Use left and right Arrow key to move the boy towards the left and right",50,345);
    text("8.this game is a bit similar to the GHOST RUNNER , play well!!" , 50,400);
    text("9.you have 3 chances for each play" , 50,450);
    textSize(40);
